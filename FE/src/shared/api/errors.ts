/**
 * API error model — mirrors the HTTP status semantics the backend will use
 * (REQUIREMENTS §9), so UI error handling written now stays valid once the
 * real HTTP adapter replaces the stub.
 */
